    ...
    <div class="span14">
		<table>
			...
			<tr>
		    	...
		    	<td><c:out value="${childDepartment.departmentName}"/></td>
			</tr>
			<tr>
		    	<td>State:</td>
		    	<td><c:out value="${childDepartment.state}"/></td>
			</tr>
		</table>
    </div>
</div>		
<content tag="breadcrumb">
    <ul class="breadcrumb">
        ...
        <li><a href="${ctx}/party/createChildDepartment/<c:out value='${childDepartment.partyId}'/>">Create Child Department</a> <span class="divider">/</span></li>
    </ul>
</content>
