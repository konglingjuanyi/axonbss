...
public class AiViewModelArgumentResolver implements HandlerMethodArgumentResolver {
    @Override
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasParameterAnnotation(AiViewModel.class);
    }
    
    @Override
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        AiViewModel aiViewModel = parameter.getParameterAnnotation(AiViewModel.class);

        String alias = getAlias(aiViewModel, parameter);
    ...
    private String getAlias(AiViewModel aiViewModel, MethodParameter parameter) {
        //得到AiViewModel的属性value，也就是对象参数的简称
        String alias = aiViewModel.value();
